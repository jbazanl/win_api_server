...
type CustomerDialpattern struct {
...
func (customerDialpattern *CustomerDialpattern) BeforeCreate(tx *gorm.DB) (err error) {
	return nil
}

func (CustomerDialpattern) TableName() string {
	return "customer_dialpattern"
}

type CreateCustomerDialpatternSchema struct {
...
type UpdateCustomerDialpatternSchema struct {
